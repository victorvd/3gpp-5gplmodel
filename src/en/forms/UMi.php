<form class="container" id="frm_parm"  name="frm_parm"  method="POST" action="">
    ...
    <div class="form-group row">
        <label class="col-sm-3 col-form-label">2D distance [10 ≤ d<sub>2D</sub> ≤ 5000]</label><!--Distancia 2D entre Tx y Rx-->
        <input
            type="number"
            name="txt_d2D"
            id="txt_d2D"
    ...
    <div class="form-group row">
        <label class="col-sm-3 col-form-label">BS height [h<sub>BS</sub> = 10]</label><!--Altura de la antena para la BS-->
        <input 
            type="number"
            value="10"
            name="txt_hBS"
            ...
            class="col-sm-2 form-control"
            title="The TR fixes the antenna height at 10 m"
            required/>
        <div class="input-group-addon">m</div>  
    </div>
    <div class="form-group row">
