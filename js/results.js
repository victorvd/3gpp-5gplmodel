...
$(document).ready(function () {
    ...
    multiples();
    //Obtener el nombre de la URL para llamar al $.post
    var pos_nam = "php/calc_" + location.pathname.substring(1);
...
function mostrResul(table) {
    ...
    var trc_nam = location.pathname.substring(1,4) + ' pathloss';
    var lay_tle = 'Pérdidas en el trayecto '
