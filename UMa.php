...
<html lang="en">
    <head>
        <title>UMa - Pérdidas en el trayecto</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="container">
            ...
            <nav class="nav nav-pills flex-column flex-sm-row">
                <a class="flex-sm-fill text-sm-center nav-link" href="RMa.php">Macrocelda rural</a>
                <a class="flex-sm-fill text-sm-center nav-link active" href="UMa.php">Macrocelda urbana</a>
            ...
            <h3><a id="hdr_calc"></a>Calculador de Atenuación</h3>
        </div>
        ...
        <form class="container" id="frm_parm"  name="frm_parm"  method="POST" action="">
            ...
            <div class="form-group row">
                ...
                <input 
                    ...
                    title="La frecuencia debe estar entre 0.5 y 100 GHz"
                    required/>
            ...
            <div class="form-group row">
                <label class="col-sm-3 col-form-label">Altura BS [h<sub>BS</sub> = 25]</label><!--Altura de la antena para la BS-->
                <input 
                    type="text"
                    value="25"
                    name="txt_hBS"
